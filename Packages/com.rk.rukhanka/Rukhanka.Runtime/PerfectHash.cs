...
{
	public static void CreateMinimalPerfectHash(in NativeArray<Hash128> inArr, out NativeList<int> seedValues, out NativeList<int> shuffleIndices)
	{
		var sz = inArr.Length;
...
/////////////////////////////////////////////////////////////////////////////////
	...
	unsafe public static int QueryPerfectHashTable(in NativeList<int> t, in Hash128 h)
	{
...
/////////////////////////////////////////////////////////////////////////////////
	...
	unsafe public static int QueryPerfectHashTable(ref BlobArray<int> t, in Hash128 h)
	{
		var tablePtr = t.GetUnsafePtr();
		var seedTableAsArr = new Span<int>(tablePtr, t.Length);
		var paramIdx = QueryPerfectHashTable(seedTableAsArr, h);
...
/////////////////////////////////////////////////////////////////////////////////
	...
	public static int QueryPerfectHashTable(ReadOnlySpan<int> t, in Hash128 h)
	{
...
/////////////////////////////////////////////////////////////////////////////////
	...
	static uint InternalHashFunc(in Hash128 v, int offset)
	{
		var o = new int4(offset, offset - 32, offset - 64, offset - 96);
		var p = new uint4(v.Value.x >> o.x, v.Value.y >> o.y, v.Value.z >> o.z, v.Value.w >> o.w);
		var rv = math.hash(p);
		return rv;
	}
}
