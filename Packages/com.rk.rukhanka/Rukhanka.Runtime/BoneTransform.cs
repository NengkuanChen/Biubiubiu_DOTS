...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static BoneTransform Multiply(in BoneTransform parent, in BoneTransform child)
	{
		...
		rv.pos = math.mul(parent.rot, child.pos) + parent.pos;
		rv.rot = math.mul(parent.rot, child.rot);
		rv.scale = child.scale;
		return rv;
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public LocalTransform GetLocalTtransform() => new LocalTransform() { Position = pos, Rotation = rot, Scale = scale.x };
}
}
