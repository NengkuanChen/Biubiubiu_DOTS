...
public struct ComputeBoneAnimationJob: IJobParallelForBatch
{
	...
	public Hash128 unnamedRootBoneHash;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void ExecuteSingle(int globalBoneIndex)
	{
		...
		var layerWeights = new FixedList128Bytes<float>();
		var refPosWeight = CalculateFinalLayerWeights(ref layerWeights, animationsToProcess, rb.hash);
		float3 totalWeights = refPosWeight;

		var boneRefPose = GetBoneRefPose(rb, rigBoneIndex, e);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	BoneTransform GetBoneRefPose(in RigBoneInfo rb, int rigBoneIndex, Entity e)
	{
		var rv = rb.refPose;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static float CalculateFinalLayerWeights(ref FixedList128Bytes<float> layerWeights, in DynamicBuffer<AnimationToProcessComponent> atp, in Hash128 boneHash)
	{
		var anm = atp[atp.Length - 1];
		var layerIndex = -1;
		layerWeights.Length = anm.layerIndex + 1;
		var w = 1.0f;
		...
		for (int i = atp.Length - 1; i >= 0; --i)
		{
			...
			var inAvatarMask = IsBoneInAvatarMask(boneHash, a.avatarMask);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static bool IsBoneInAvatarMask(in Hash128 boneHash, ExternalBlobPtr<AvatarMaskBlob> am)
	{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	(BoneTransform, float3) SampleAnimation(ref BoneClipBlob bcb, float time, in AnimationToProcessComponent atp)
	{
		var (bonePose, flags) = ProcessAnimationCurves(ref bcb, time);
		
		//	Make additive animation if requested
		if (atp.blendMode == AnimationBlendingMode.Additive)
		{
			var (zeroFramePose, _) = ProcessAnimationCurves(ref bcb, atp.animation.Value.additiveReferencePoseTime);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	(BoneTransform, float3) ProcessAnimationCurves(ref BoneClipBlob bcb, float time)
	{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	unsafe public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
	{
		...
		while (cee.NextEntityIndex(out var i))
		{
			...
			ComputeBoneAnimationJob.CalculateFinalLayerWeights(ref layerWeights, animationsToProcess, new Hash128());
			...
			for (int l = 0; l < animationsToProcess.Length; ++l)
			{
				...
				for (int k = 0; k < curves.Length; ++k)
				{
					...
					var paramIdx = PerfectHash.QueryPerfectHashTable(ref paramIndexTable.seedTable.Value.seedTable, c.hash);
					var hasParam = paramIdx < animationParameters.Length && c.hash == animationParameters[paramIdx].hash;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
	{
		...
		while (cee.NextEntityIndex(out var i))
		{
			...
			var entityBoneOffset = entityToDataOffsetMap[e];
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	SkinMatrix MakeSkinMatrixForBone(in SkinnedMeshBoneInfo boneInfo, in float4x4 boneXForm, in float4x4 entityToRootBoneTransform)
	{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
	{
		...
		while (cee.NextEntityIndex(out var i))
		{
			...
			var boneDataOffset = entityToDataOffsetMap[rigEntity];
			...
			for (int animationBoneIndex = 0; animationBoneIndex < rigBones.Length; ++animationBoneIndex)
			{
				...
				var skinMatrix = MakeSkinMatrixForBone(boneInfo, boneXForm, entityToRootBoneTransform);
