...
public class SkinnedMeshBaker: Baker<SkinnedMeshRenderer>
{
	public override void Bake(SkinnedMeshRenderer a)
	{
		...
		var bd = new SkinnedMeshBakerData
		{
			...
			animatedRigEntity = GetEntity(a.gameObject.GetComponentInParent<RigDefinitionAuthoring>(true)),
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{ 
		...
		for (int j = 0; j < r.bones.Length; ++j)
		{
			...
			var refPose = new BoneTransform();
			refPose.pos = b.localPosition;
			refPose.scale = b.localScale;
			refPose.rot = b.localRotation;
			oneBoneInfo.refPose = refPose;
