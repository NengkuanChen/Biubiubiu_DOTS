...
//
//         foreach (var (localTransform, spectatorController) in SystemAPI.Query<LocalTransform, RefRW<SpectatorController>>())
//         {
...
//
//             // Velocity
//             float3 worldMoveInput = math.mul(localTransform.LocalRotation, moveInput);
